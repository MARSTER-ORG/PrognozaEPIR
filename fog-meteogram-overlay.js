...
(() => {
  ...
  function brSeries() {
    ...
    // IMPORTANT: never publish this fallback. br-engine.js owns the global BR
    // series; overwriting it here was one cause of BR disappearing on meteogram.
  ...
  function install(){
    ...
    installLegendNote();
    window.__EPIR_FOG_METEOGRAM_OVERLAY_VERSION__='2026-09-18-panel-sync2';
    return true;
  }
