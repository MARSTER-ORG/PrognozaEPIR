...
assert.ok(html.includes('taf-engine-v2.js?v=2.3.0-kernel'));assert.ok(html.includes('taf-engine-v24.js?v=2.4.0'));assert.ok(html.includes('taf-app-v2.js?v=2.4.0-ui'));assert.ok(html.includes('Chmury (m AGL)'));assert.ok(html.includes('Pułap BKN/OVC (m AGL)'));
